...
void StateMachine::FavouriteScreenStateHandler::onInitialDraw() {
    Ui::clear();
...
void StateMachine::FavouriteScreenStateHandler::onUpdateDraw() {
    Ui::clearRect(
        0,
        0,
        BORDER_GRAPH_L_X,
...
void StateMachine::FavouriteScreenStateHandler::drawBorders() {
...
void StateMachine::FavouriteScreenStateHandler::drawChannelText() {
    display.setTextSize(CHANNEL_TEXT_SIZE);
    display.setTextColor(WHITE);
    display.setCursor(CHANNEL_TEXT_X, CHANNEL_TEXT_Y);

    display.print(Channels::getName(Receiver::activeChannel));
}

void StateMachine::FavouriteScreenStateHandler::drawFrequencyText() {
